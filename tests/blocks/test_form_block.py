    ...
    def test_render(self):
        ...
        expected_html = "\n".join(
            [
                ...
                '<input aria-describedby="id_hidden_helptext" id="id_hidden" name="hidden" type="hidden">',
                ...
                '<input aria-describedby="id_singleline_helptext" id="id_singleline" name="singleline" required type="text">',
                '<p class="help-text">Help</p>',
                "</div>",
                '<div class="field-row">',
                '<label for="id_multiline">multiline</label>',
                '<textarea aria-describedby="id_multiline_helptext" cols="40" id="id_multiline" name="multiline" required rows="10">',
                "</textarea>",
                '<p class="help-text">Help</p>',
                "</div>",
                '<div class="field-row">',
